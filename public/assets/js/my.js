    ...
    var ae = function() {
            ...
            return t = e, (s = [{
                ...
                value: function() {
                    ...
                    })), this.clickHandler()) : console.error('Не найден элемент с селектором "'.concat(this.options.selector, '"'))
                }
            }, {
                key: "clickHandler",
                value: function() {
                    ...
                    })) : console.error('Не найден элемент с селектором "'.concat(this.options.openButton, '"')), this.modals.forEach((function(t) {
                        var s = t.querySelectorAll("".concat(e.options.closeButton));
                        s && s.forEach((function(t) {
                            t.addEventListener("click", (function(t) {
                                t.stopPropagation();
                                var s = t.currentTarget.closest("".concat(e.options.selector));
                                s ? e.close(s) : console.error('Не найден элемент с data атрибутом "'.concat(e.options.selector, '"'))
                            }))
                        }));
                ...
                value: function(e) {
                    ...
                    t ? (t.classList.add("".concat(this.options.activeClass)), this.bodyElement.style.overflow = "hidden") : console.error("Не найдено соответствующее окно с атрибутом равным ".concat(e))
                }
            }, {
                key: "close",
                value: function(e) {
