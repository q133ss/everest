...
class SectionCatController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('admin.sections.section_cat.index', compact('categories'));
    }
    ...
    {
        return view('admin.sections.section_cat.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.sections.section_cat.edit', compact('cat'));
    }
